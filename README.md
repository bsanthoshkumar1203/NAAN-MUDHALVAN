...
> [**Barbershop: GAN-based Image Compositing using Segmentation Masks**](https://github.com/bsanthoshkumar1203/NAAN-MUDHALVAN.git/)<br/>
...
``` 
git clone https://github.com/bsanthoshkumar1203/NAAN-MUDHALVAN.git
cd Barbershop
```
- Dependencies:  
...
## Acknowledgments
This code borrows heavily from [II2S](https://github.com/bsanthoshkumar1203/NAAN-MUDHALVAN.git)
## BibTeX
